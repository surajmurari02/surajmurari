    ...
    >
      ...
      <div className={`flex w-full ${
        ...
        <div className="flex-1 relative z-10 space-y-4">
          ...
          <div className="flex gap-3 pt-3">
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`inline-flex items-center gap-2 px-3 py-2 text-sm rounded-lg font-medium transition-all duration-300 ${
                theme === 'light'
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`inline-flex items-center gap-2 px-3 py-2 text-sm rounded-lg font-medium border transition-all duration-300 ${
                theme === 'light'
        ...
        <motion.div 
          ...
          className="flex-shrink-0 w-full md:w-80 h-48 md:h-56 rounded-xl overflow-hidden relative border border-white/20 shadow-lg"
        >
